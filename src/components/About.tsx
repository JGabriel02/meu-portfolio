...
export default function AboutSection() {
  return (
    <section
      id="about"
      className="snap-start min-h-screen flex flex-col justify-center items-center text-center gap-6 px-6 pb-20 pt-20 bg-gradient-to-br from-gray-800 via-black to-gray-900 text-white overflow-y-auto"
    >
      {/* Título */}
      <motion.h2
      ...
      >
        <h3 className="text-2xl font-semibold text-white mt-4">Idiomas</h3>
      ...
      >
        <h3 className="text-2xl font-semibold text-white mt-4">Educação</h3>
